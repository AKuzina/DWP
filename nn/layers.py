...
class BasicDownBlock(nn.Module):
    """
    (Norm => ReLU => conv3D => Norm => ReLU => conv3D) with resnet-like structure
    """
...
class BasicUpBlock(nn.Module):
    """
    Norm => ReLU => conv3D => TrilinearUpsample =>
    Norm => ReLU => conv3D => Norm => ReLU => conv3D
    """
